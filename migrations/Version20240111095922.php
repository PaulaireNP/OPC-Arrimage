 ...
 */
final class Version20240111095922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE documents (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) DEFAULT NULL, file VARCHAR(255) DEFAULT NULL, visible TINYINT(1) DEFAULT NULL, categorie VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
